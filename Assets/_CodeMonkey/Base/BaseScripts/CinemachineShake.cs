...
using UnityEngine;
// using Cinemachine; // Commented out - package not installed
using CodeMonkey.Utils;

// NOTE: This script requires Cinemachine package - currently disabled
// Install via: Window → Package Manager → Unity Registry → Cinemachine
public class CinemachineShake : MonoBehaviour {

    public static CinemachineShake Instance { get; private set; }

    /* Cinemachine functionality disabled
